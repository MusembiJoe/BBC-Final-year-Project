...
<div class="intro-page" >
    ...
    <div class="flex-p">
        <div class="content-p">
            ...
            <form class="form-horizontal" action="more2-symptoms.php" method="post">
                ...
                <table id="example"  cellspacing="3" width="100%">
                    ...
                    <tbody>
                    <?php $sql = "SELECT symptoms_tb.symptoms_id,symptoms_tb.symptoms_name from symptoms_tb where id IN (33,34)";
