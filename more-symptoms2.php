...
<div class="intro-page" >
    ...
    <div class="flex-p">
        <div class="content-p">
            ...
            <form class="form-horizontal" action="more-symptoms3.php" method="post">
                ...
                <table id="example" cellspacing="2" width="100%">
                    ...
                    <tbody>
                    <?php $sql = "SELECT symptoms_tb.symptoms_id,symptoms_tb.symptoms_name from symptoms_tb where id IN (38,39,40,41,42)";
            ...
            <div class="flex-p-inside">
                <div class="flex-p-1">
                    <li><a href="more-symptoms1.php" ><button><<</button></li>
                </div>
            </div>
