...
<div class="intro-page" >
    ...
    <div class="flex-p">
        <div class="content-p">
            ...
            <form class="form-horizontal" action="more-symptoms-analyzing.php" method="post">
                ...
                <table id="example"  cellspacing="3" width="100%">
                    ...
                    <tbody>
                    <?php $sql = "SELECT symptoms_tb.symptoms_id,symptoms_tb.symptoms_name from symptoms_tb where id IN (47,48,49,50,51)";
            ...
            <div class="flex-p-inside">
                <div class="flex-p-1">
                    <li><a href="more-symptoms2.php" ><button><<</button></li>
                </div>
            </div>
