...
<div class="intro-page" >
    ...
    <div class="flex-p">
        <div class="content-p">
            ...
            <form class="form-horizontal" action="more-symptoms2.php" method="post">
                ...
                <table id="example"  cellspacing="3" width="100%">
                    ...
                    <tbody>
                    <?php $sql = "SELECT symptoms_tb.symptoms_id,symptoms_tb.symptoms_name from symptoms_tb where id IN (26,27,28,29,30,31,32)";
